package si.f5.qwe0412.sweetpotato;
...
public class Sweetpotato {
    ...
    public Sweetpotato(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (Sweetpotato) to respond directly to events.
